...
The one downside of my hacky middleman setup is that I will need to manually port those blog posts over as it's a mess. A lot of it is related to image and video links and some `rb -> md`. Many of the really old posts references images on long gone resources (`primates.ximian.com`?) and most just have broken links. I've started recovering some of the [old gems](/posts/new-zealand-part-1/)), but I'm definitely only going to resurrect a few.
